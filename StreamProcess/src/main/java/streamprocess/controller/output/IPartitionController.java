...
public interface IPartitionController extends Serializable {
    ...
    int force_emit_ID(Meta meta, String streamId, int targetId, long bid, Object... output) throws InterruptedException;
...
//	int emit_marked(String streamId, List<Object> output, Marker marker);
    ...
    int create_marker_single(Meta meta, String streamId, long timestamp, long bid, int myiteration,String msg);

    int create_marker_boardcast(Meta meta, String streamId, long timestamp, long bid, int myiteration,String msg) throws InterruptedException;
