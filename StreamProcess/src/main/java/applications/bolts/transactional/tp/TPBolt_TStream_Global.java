...
public class TPBolt_TStream_Global extends TPBolt_TStream_Conventional {
    private static final Logger LOG = LoggerFactory.getLogger(TPBolt_TStream_ISC.class);
    private static final long serialVersionUID = 8929512710864617149L;
    public TPBolt_TStream_Global(int fid) {
        super(fid);
    }
