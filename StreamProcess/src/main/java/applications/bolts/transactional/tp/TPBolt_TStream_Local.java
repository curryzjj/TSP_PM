...
public class TPBolt_TStream_Local extends TPBolt_TStream_Conventional {

    private static final long serialVersionUID = 1803800836632803198L;
    public TPBolt_TStream_Local(int fid) {
        super(fid);
    }
