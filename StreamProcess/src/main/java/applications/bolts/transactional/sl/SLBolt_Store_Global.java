...
public class SLBolt_Store_Global extends SLBolt_Store{
    private static final long serialVersionUID = 3272482130628502590L;
    public SLBolt_Store_Global(int fid) {
        super(fid);
    }
