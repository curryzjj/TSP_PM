...
public class GSBolt_TStream_Local extends GSBolt_TStream_Conventional{

    private static final long serialVersionUID = 1664583404486951664L;

    public GSBolt_TStream_Local(int fid) {
        super(fid);
    }
