...
public class GSBolt_SStore_Global extends GSBolt_SStore{
    private static final long serialVersionUID = -8860021107165594306L;

    public GSBolt_SStore_Global(int fid) {
        super(fid);
    }
