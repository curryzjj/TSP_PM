...
public class OBBolt_TStream_Global extends OBBolt_TStream_Conventional{
    private static final long serialVersionUID = -1355397737386667955L;
    public OBBolt_TStream_Global(int fid) {
        super(fid);
    }
    @Override
